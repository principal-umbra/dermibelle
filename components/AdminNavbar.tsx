        ...
        <div className="relative" ref={calendarRef}>
            ...
            >
                <div className="flex flex-col items-end text-right text-gray-700">
                    <span className="block text-xs text-gray-400 font-medium uppercase tracking-wider">Hoy</span>
                    <span className="text-sm font-bold whitespace-nowrap">
                        {new Date().toLocaleDateString('es-ES', { day: 'numeric', month: 'short' })}, {new Date().getFullYear()}
                    </span>
                </div>
