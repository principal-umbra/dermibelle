...
const CatalogProductDetails: React.FC<CatalogProductDetailsProps> = ({ editingItem, setEditingItem, suppliers, lockedSupplierId }) => {
    ...
    }, [unitCost, acquisitionCost, purchaseMode, unitsPerPack, usageMode, netContent, measureUnit, trackBatch, expiryDate, currentBatch, retailRatio, containerType]);
