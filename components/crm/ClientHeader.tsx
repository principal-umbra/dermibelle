...
const StatItem = ({ label, value, subtext, dotColor, isPill = false, pillClass = '', pillIcon = '', tooltip }: any) => {
    return (
        <div className="flex flex-col justify-center px-4 py-3 md:py-2 flex-1 min-w-[140px] md:min-w-[110px] group relative cursor-help hover:bg-gray-50/50 dark:hover:bg-white/5 transition-all hover:z-50 border-gray-100 dark:border-gray-700/50">
