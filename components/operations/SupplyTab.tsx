            ...
            <div className="shrink-0 mb-4 pt-2">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                        ...
                        {/* SUB-NAVIGATION - Responsive Wrap */}
                        <div className="bg-white dark:bg-surface-dark p-1.5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm flex flex-wrap gap-1 items-center self-start md:self-auto relative">
                            <button
                            ...
                            >
                                <span className="material-icons text-sm">local_shipping</span> Órdenes
                            </button>
                            <button
