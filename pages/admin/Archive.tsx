  ...
  return (
    <div className="flex flex-col h-full bg-[#F3F4F6] dark:bg-background-dark p-6">
      <div className="mb-6 flex-shrink-0">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Archivo de Citas</h1>
        <p className="text-sm text-gray-500">Historial operativo y recuperación de flujo.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 flex-shrink-0">
          ...
          <div className="bg-white dark:bg-surface-dark p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex items-center justify-between">
              <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-1">
                      ...
                      <span className="text-[10px] text-gray-400">históricas</span>
                  </div>
              </div>
          ...
          <div className="bg-white dark:bg-surface-dark p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex items-center justify-between">
              <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-1">
                      ...
                      <span className="text-[10px] text-gray-400">en archivo</span>
                  </div>
              </div>
          ...
          <div className="bg-white dark:bg-surface-dark p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 shadow-sm flex items-center justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                  <p className="text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">Recuperadas</p>
                  <div className="flex items-baseline gap-2 mt-1">
                      <h3 className="text-2xl font-display font-bold text-blue-900 dark:text-white">{stats.recovered}</h3>
                      <span className="text-[10px] text-blue-600/70 dark:text-blue-300">salvadas</span>
                  </div>
              </div>
