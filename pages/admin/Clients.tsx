    ...
    <div className="flex flex-col h-full bg-[#F3F4F6] dark:bg-background-dark p-6">
      <div className="flex justify-between items-center mb-6 flex-shrink-0">
        <div>
            ...
            <p className="text-sm text-gray-500">Base de datos de clientes CRM.</p>
        </div>
        <button onClick={handleOpenClientModal} className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-green-800 flex items-center gap-2 shadow-sm">
            <span className="material-icons text-sm">person_add</span> Nuevo Cliente
        </button>
      </div>
