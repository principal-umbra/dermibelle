...
const Dashboard: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#F3F4F6] dark:bg-background-dark p-4 md:p-6 overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-4 md:mb-6 flex-shrink-0">
                <div>
                    <h1 className="font-display text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Dashboard Principal</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm">Bienvenida de nuevo, Elena. Resumen de actividad.</p>
                </div>
            </div>

            {/* Main Scrollable Content */}
            <div className="flex-1 min-h-0 overflow-y-auto space-y-4 md:space-y-6 pr-1 md:pr-2 custom-scrollbar">
                {/* Top Row: Stats & Services */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

                    {/* Stat 1: Citas Hoy (Real Data) */}
                    <div className="bg-white dark:bg-surface-dark rounded-xl p-4 md:p-5 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col justify-between min-h-[9rem] md:h-40 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-gray-500 dark:text-gray-400 text-[10px] font-bold uppercase tracking-wider mb-1">Citas Hoy</p>
                                <h3 className="text-2xl md:text-3xl font-display font-bold text-gray-900 dark:text-white">{todayCount}</h3>
                                <p className="text-[10px] text-gray-400 mt-1">{todayCount === 0 ? 'Sin actividad' : 'programadas'}</p>
                            </div>
                        ...
                        <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-1 mt-3">
                            <div className="bg-blue-500 h-1 rounded-full transition-all duration-1000" style={{ width: `${capacityPercentage}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-surface-dark rounded-xl p-4 md:p-5 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col justify-between min-h-[9rem] md:h-40 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-gray-500 dark:text-gray-400 text-[10px] font-bold uppercase tracking-wider mb-1">Ingresos</p>
                                ...
                                <p className="text-[10px] text-gray-400 mt-1">Mensuales (USD)</p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-surface-dark rounded-xl p-4 md:p-5 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col justify-between min-h-[9rem] md:h-40 hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-gray-500 dark:text-gray-400 text-[10px] font-bold uppercase tracking-wider mb-1">Nuevos Clientes</p>
                                <h3 className="text-2xl md:text-3xl font-display font-bold text-gray-900 dark:text-white">{newClientsCount}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-6">
                    ...
                    <div className="lg:col-span-2 bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col">
                    ...
                    <div className="lg:col-span-1 bg-surface-dark rounded-xl p-4 md:p-5 shadow-lg text-white relative overflow-hidden flex flex-col h-full max-h-[350px] md:max-h-[400px]">
