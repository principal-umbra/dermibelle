  ...
  return (
    <div className="flex flex-col h-full bg-[#F3F4F6] dark:bg-background-dark p-6 sm:p-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8 flex-shrink-0">
        <div>
            <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white sm:text-3xl flex items-center gap-3">
              Centro de Actividad
              {stats.unread > 0 && (
                  <span className="bg-red-500 text-white text-sm font-body font-bold px-2.5 py-0.5 rounded-full shadow-sm animate-pulse">
                      {stats.unread} nuevas
                  </span>
              )}
            </h2>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Monitoreo en tiempo real de eventos y alertas del sistema.
            </p>
        </div>
        
        {/* Quick Stats Cards */}
        <div className="flex gap-3 overflow-x-auto pb-2 lg:pb-0">
            <div className="bg-white dark:bg-surface-dark px-4 py-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-3 min-w-[140px]">
                ...
                <div>
                    <span className="block text-xl font-bold text-gray-900 dark:text-white">{stats.appointments}</span>
            ...
            <div className="bg-white dark:bg-surface-dark px-4 py-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-3 min-w-[140px]">
                ...
                <div>
                    <span className="block text-xl font-bold text-gray-900 dark:text-white">{stats.payments}</span>
