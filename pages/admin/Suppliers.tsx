...
const Suppliers: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F3F4F6] dark:bg-background-dark">
      {/* Header */}
      <header className="bg-surface-light dark:bg-surface-dark border-b border-gray-200 dark:border-gray-800 h-16 flex items-center justify-end px-6 sm:px-8 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-6 sm:p-8">
        <div className="md:flex md:items-center md:justify-between mb-8">
          <div className="min-w-0 flex-1">
            <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white sm:text-3xl sm:truncate">
              Proveedores
            </h2>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Gestiona tu cadena de suministro, pedidos y relaciones comerciales.</p>
          </div>
          <div className="mt-4 flex md:ml-4 md:mt-0 space-x-3">
            <button className="inline-flex items-center rounded-md bg-white dark:bg-surface-dark px-3 py-2 text-sm font-semibold text-gray-900 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors" type="button">
              <span className="material-icons text-lg mr-1.5 text-gray-400">download</span>
              Exportar Lista
            </button>
            <button className="inline-flex items-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-800 transition-colors" type="button">
              <span className="material-icons text-lg mr-1.5">add_business</span>
              Nuevo Proveedor
            </button>
          </div>
        </div>
